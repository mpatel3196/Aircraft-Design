...
from weight_estmation_functions import *
...
# We_W0 = A*(W0_guess**C)
We_W0 = empty_weight_fraction(W0_guess, aircraft_type=14)
...
We_W0 = empty_weight_fraction(W0, aircraft_type=14)
# W_empty = We_W0 * W0 # Empty weight calcualtio
W_empty = get_empty_weight(W0, We_W0)
